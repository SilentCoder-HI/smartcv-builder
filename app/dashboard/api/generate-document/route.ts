...
export async function POST(req: NextRequest) {
  ...
  <div style="width:100%; font-size:10px; color:#666; padding:6px 20px; display:flex; justify-content:space-between; align-items:center;">
    <div style="display:flex; align-items:center; gap:6px;">
      <img src="${baseUrl}/SmartCV.ico" style="height:14px;" alt="MyCVs Logo" />
...
<div style="width:100%; font-size:10px; color:#666; padding:6px 20px; display:flex; justify-content:space-between; align-items:center;">
  <div style="display:flex; align-items:center; gap:6px;">
    <img src="https://yourdomain.com/logo.png" style="height:14px;" alt="MyCVs Logo" />
...
`;
    ...
    let pdfBuffer = await page.pdf({
      format: "A4",
      margin: { top: 40, right: 0, bottom: 40, left: 0 }, // 0px left/right margin
    ...
    return new Response(finalPdfBuffer, {
      ...
      headers: {
        ...
        "Content-Disposition": 'attachment; filename="SmartCV.pdf"; name="SmartCV Resume PDF"',
